<template>
  <div class="flex items-baseline">
    <label
      class="flex items-center w-full px-5 py-2 cursor-pointer hover:bg-purple-100"
      ...
      <button
        class="p-2 ml-2 focus:outline-none"
        @click="deleteItem(item)">
        <svg viewBox="-40 0 427 427.00131" class="w-5" xmlns="http://www.w3.org/2000/svg">
